...
TEST(LEXER_TEST, lexer) {
    ...
    ASSERT_EQ(tokens[45].type, TokenType::TYPE);
    ASSERT_EQ(tokens[46].type, TokenType::TYPE);
    ASSERT_EQ(tokens[47].type, TokenType::TYPE);
    ASSERT_EQ(tokens[48].type, TokenType::TYPE);
    ASSERT_EQ(tokens[49].type, TokenType::TYPE);
    ASSERT_EQ(tokens[50].type, TokenType::TYPE);
    ASSERT_EQ(tokens[51].type, TokenType::TYPE);
    ASSERT_EQ(tokens[52].type, TokenType::TYPE);
    ASSERT_EQ(tokens[53].type, TokenType::TYPE);
    ASSERT_EQ(tokens[54].type, TokenType::TYPE);
    ASSERT_EQ(tokens[55].type, TokenType::TYPE);
    ASSERT_EQ(tokens[56].type, TokenType::TYPE);
    ASSERT_EQ(tokens[57].type, TokenType::TYPE);
    ASSERT_EQ(tokens[58].type, TokenType::TYPE);
    ASSERT_EQ(tokens[59].type, TokenType::TYPE);
